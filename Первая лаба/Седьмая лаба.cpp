...
int main()
{
    ...
    if (_getcwd(buffer, sizeof(buffer)) != NULL) {
        cout << "Текущая директория: " << buffer << endl;
    }

    cout << "Файл модели должен лежать в этой папке или укажите полный путь!\n";
    cout << "===========================================\n" << endl;
    ...
    cout << "Загрузка модели из: " << modelPath << endl;
    myModel.loadModel(modelPath);
